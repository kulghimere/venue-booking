    ...
    <div className={styles.page}>
      <div className={`${styles.card} ${styles.cardWide}`}>
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          ...
          <div className={`${styles.consentBox} ${errors.agreed ? styles.consentBoxError : ''}`}>
            <label className={styles.agreeRow}>
              ...
              />
              <span>
                I have read and agree to VenueBook's{' '}
                <Link to="/terms" target="_blank" rel="noopener noreferrer" className={styles.legalLink}>
                  Terms of Service
                </Link>
                {' '}and{' '}
                <Link to="/privacy" target="_blank" rel="noopener noreferrer" className={styles.legalLink}>
                  Privacy Policy
                </Link>
              </span>
            </label>
            ...
            <div className={styles.consentSummary}>
              <div className={styles.consentPoint}>
              ...
              <div className={styles.consentPoint}>
                ...
                <span>We only email you for bookings and account security</span>
              </div>
              <div className={styles.consentPoint}>
                <span className={styles.consentIcon}>🗑️</span>
            ...
            {errors.agreed && (
              <div className={styles.consentError}>⚠ {errors.agreed}</div>
            )}
          </div>
