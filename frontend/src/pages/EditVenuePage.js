...
export default function EditVenuePage() {
    ...
    api.get(`/venues/${id}`)
      .then(r => {
        ...
        setForm({
          ...
          country: v.location?.country || 'UK',
          imageUrl: img,
          amenities: v.amenities || [],
          rules: v.rules?.length ? v.rules : [''],
  ...
  if (fetching) return <div style={{ paddingTop: 68, minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#8892b0' }}>Loading venue…</div>;
      ...
      <div className="container">
        <form className={styles.form} onSubmit={handleSubmit}>
          <div className={styles.section}>
            ...
            <div className={styles.fieldGroup}><label>Description *</label><textarea required rows={4} placeholder="Describe your venue…" value={form.description} onChange={e => set('description', e.target.value)} /></div>
